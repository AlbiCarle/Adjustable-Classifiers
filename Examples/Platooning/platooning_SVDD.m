...
y_pred = SSVDD_Test(Xtr, Ytr, Xts, alpha, R, 0, kernel, param, eta);
...
Gamma_rho = barrho(Xtr, Ytr, Xcl_U, R, alpha, kernel, param, eta);
...
y_star_pred = SSVDD_Test(Xtr, Ytr, Xts, alpha, R, rho_star, kernel, param, eta);
y_star_pred_cl = SSVDD_Test(Xtr, Ytr, Xcl, alpha, R, rho_star, kernel, param, eta);
